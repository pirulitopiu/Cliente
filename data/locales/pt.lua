locale = {
  ...
  translation = {
    ...
    ["Comment"] = "Comentário",
    ["Connecting to game server..."] = "Conectando No Pokemon BS, Aproveite...",
    ["Connecting to login server..."] = "Conectando No Pokemon BS...",
    ["Connection Error"] = "Erro de Conexão, Com O Pokemon BS!",
    ["Console"] = "Console",
    ["Cooldown"] = "Cooldown",
    ["Cooldowns"] = "Cooldowns",
    ...
    ["Your connection has been lost. (err: %d)"] = "A sua conexão foi perdida Com O Pokemon BS. (err: %d)",
